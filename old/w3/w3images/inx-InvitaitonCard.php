...
<html lang="en-US">  <!--google translate-->
<title>Coupon</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="https://ivyboarding.com/w3template/w3.css">
<link rel="stylesheet" href="https://ivyboarding.com/w3template/w3-theme-blue-grey.css"><!--메뉴바 색상용--->
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway">
...
-->
<link rel="stylesheet" href="https://ivyboarding.com/w3template/w3.css">
<link rel="stylesheet" href="https://ivyboarding.com/w3template/w3-fix.css">  <!--topnav에 대한 추가 css사항-->
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lato">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Oswald">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open Sans">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat">  <!---grid---->
...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    <a href="inx-InvitaitonCard.php#home" style="width:25%" class="w3-bar-item w3-button">Home</a>
    <a href="inx-InvitaitonCard.php#us" style="width:25%" class="w3-bar-item w3-button">Jane & John</a>
    <a href="inx-InvitaitonCard.php#wedding" style="width:25%" class="w3-bar-item w3-button">Wedding</a>
    <a href="inx-InvitaitonCard.php#rsvp" style="width:25%" class="w3-bar-item w3-button w3-hover-black">RSVP</a>
  </div>
</div>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min" id="us">
  <div class="w3-content">
    ...
    <p class="w3-center"><a href="inx-InvitaitonCard.php#wedding" class="w3-button w3-black w3-round w3-padding-large w3-large">Wedding Details</a></p>
  </div>
</div>
